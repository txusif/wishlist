...
export function WishlistCard({
  ...
  return (
    ...
    >
      <div
        className={`h-full bg-card rounded-lg overflow-hidden shadow-lg transition-all duration-200 border border-primary/20 ${
          item.bought ? "opacity-70" : ""
        }`}
      >
        {/* Badges Row */}
        <div className="p-3 flex items-center gap-2 flex-wrap bg-muted/30">
